...
const settingsSchema = new mongoose.Schema({
    OWNER_NUMBER: { type: String, default: "94766863255" },
    ...
    APIKEY: { type: String, default: "key_13be1374312cdd0a" },
    TITLE: { type : String, default: "🎬VISPER-MD🎬" },
    DCARD: { type : String, default: "" },
    ...
    LOGO: { type: String, default: "https://visper-full-db.pages.dev/Data/visper-logo.png" },
    MAINMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    GROUPMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    OWNERMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    CONVERTMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    AIMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    LOGOMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    DOWNMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    SEARCHMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    OTHERMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
    MOVIEMENU: { type: String, default: "https://files.catbox.moe/f3nwkv.png" },
...
async function connectdb() {
    try {
        await mongoose.connect('mongodb://mongo:CoZjCFPsQykuftLuBcujoAnBPiidsMgb@hayabusa.proxy.rlwy.net:39542');
